...
class Program
{
    static void Main(string[] args)
    {
        ...
        usernameField.SendKeys("lora_dauris29");
        passwordField.SendKeys("Amelia170198.");
        ...
        for (int i=1; i <= botonn; i ++)
        {
            ...
            if (boton.Text == "Seguir")
            {
                ...
                //Aqui escribe en pantalla que siguio a alguien// Aun trabajo en que imprima en pantalla el nombre de la persona a la que le dio click en seguir
                Console.WriteLine("Se siguio: " + nom+ i);
            }
